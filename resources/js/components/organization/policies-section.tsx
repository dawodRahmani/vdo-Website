                        ...
                        {displayedPolicies.map((policy, index) => (
                            ...
                            >
                                <div className="mb-3 flex items-start gap-3">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#23369C]/10">
                                        <policy.icon className="h-5 w-5 text-[#23369C]" />
                                    </div>
                                    <div>
                    ...
                    {filteredPolicies.length > 12 && (
                        <div className="mt-8 text-center">
                            <button
                                ...
                                className="inline-flex items-center gap-2 rounded-lg bg-[#23369C] px-6 py-3 font-medium text-white transition-colors hover:bg-[#23369C]/90"
                            >
                                {showAll ? (
                                    <>
                                        Show Less
