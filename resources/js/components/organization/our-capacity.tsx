                ...
                <div className="mx-auto max-w-5xl">
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {capacityStats.map((stat, index) => (
                            ...
                            >
                                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#23369C]/10 transition-colors group-hover:bg-[#23369C]">
                                    <stat.icon className="h-7 w-7 text-[#23369C] transition-colors group-hover:text-white" />
                                </div>
                                <p className="mb-1 text-3xl font-bold text-[#23369C]">
                                    {stat.value}
                                </p>
                    ...
                    <div className="mt-12 rounded-xl bg-gradient-to-r from-[#23369C]/5 to-[#00B7EC]/5 p-8">
